Our goal is to implemente deferred retrieval in the context of PBACN-ICN, 
and modify how interest packets are fetched to obscure traffic patterns and prevent correlation attacks.
...
The baseline for this project should include:
    1. Simulate a basic ICN network with interest packets and PBACN routing.
    2. Introduce deferred retrieval—randomly delay the fetching of interest packets.
    3. Compare two cases:
        Without deferred retrieval (Packets fetched immediately)
        With deferred retrieval (Packets fetched after randomized delay)
...
DeferredRetrievalSimulator Class:
    ...
    I also added plotting functionality for a histogram of fetch delays to visualize how well traffic is obfuscated. 
    This is mainly for testing as I like to see data visulized on a graph.
...
Additionally, through the use of cache, traffic is harder to correlate because some packets never go through the network.
